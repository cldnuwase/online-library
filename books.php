...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    if (isset($_FILES['file']) && $_FILES['file']['error'] == 0) {
        ...
        if (move_uploaded_file($_FILES['file']['tmp_name'], $filePath)) {
            if ($book->addBook($title, $author, $filePath, $availableCopies)) {
...
<a href="admin_dashbord.php">← Back to Admin Dashboard</a><br><br>
...
<form method="POST" enctype="multipart/form-data">
    ...
    <input type="number" name="available_copies" required><br><br>

    <label>Upload PDF:</label>
    <input type="file" name="file" accept="application/pdf" required><br><br>

    <input type="submit" name="add" value="Insert Book" style='background-color:#333'>
</form>
...
<?php if ($editBook) : ?>
    ...
    <form method="POST">
        ...
        <input type="submit" name="update" value="Update Book" style='background-color:#333'>
    </form>
<?php endif; ?>
